...
def sixtyfive(**kwargs):
    ...
    # Don't round if the answer is the string "large" (for Ka/Kb)
    return answer[1] if isinstance(answer[1], str) else round_sig(answer[1])
...
def sixtyseven(**kwargs):
    ...
    try:
        ...
        # Neutralization was too complete, skip pH questions and only ask about salt
        one = []
